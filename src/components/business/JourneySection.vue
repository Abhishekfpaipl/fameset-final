<template>
    <div class="container my-5">
        <h1 class="mb-2">
            <span class="text-warning">Your Journey</span> on Covisor Biz
        </h1>
        <p class="text-muted mb-4">
            Starting your online business with Covisor Biz is easy. 14 lakh+ sellers trust Covisor Biz with their business
        </p>
    ...
    data() {
        return {
            steps: [
                ...
                {
                    title: "List",
                    description: "List your products (min 1 no.) that you want to sell on Covisor Biz.",
                    image: "https://static-assets-web.flixcart.com/fk-sp-static/images/prelogin/icons/Group_2_1.svg"
                },
                {
                    title: "Orders",
                    description: "Receive orders from over 45 crore+ Covisor Biz customers.",
                    image: "https://static-assets-web.flixcart.com/fk-sp-static/images/orders-icon.svg"
                },
                {
                    title: "Shipment",
                    description: "Covisor Biz ensures stress free delivery of your products",
