        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-4 my-3">
                <div class="col" v-for="(plan, index) in plans" :key="index">
                    <div class="card mb-3 px-3 py-2 rounded-0 bg-dark text-white" :class="{ 'recommended': index === 2 }"
                        style="">
                        ...
                        <div class="card-body text-center">
                            ...
                            <ul v-if="plan.features" class="list-group">
                                ...
                                <li v-for="(feature, featureIndex) in plan.features.slice(0, 2)" :key="featureIndex"
                                    class="px-0 d-flex justify-content-between list-group-item bg-dark text-white text-start text-capitalize border-0 smaller"
                                     >
                                    <div class="">
